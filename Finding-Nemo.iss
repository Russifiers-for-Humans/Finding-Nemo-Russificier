...
; Всегда меняются
#define GameName "Finding Nemo"                                          ; Название игры
#define GameNameDash "Finding-Nemo"                                                          ; Название игры без пробелов
#define GameNameEXE "Finding-Nemo"                                                              ; Название exe файла игры
#define GameVer "1.0"                                                                     ; Версия игры
#define GameAppIdSteam "331450"                                                             ; Ид игры в стиме
; От ситуации зависит
...
[Setup]
; Номер приложения для его удаление лучше все время не забывать разный совать. Проверка уникальный для: Finding Nemo Russificier
AppId={{C8FB1FF8-21AB-4080-A6C1-E4B8E63245DD}
